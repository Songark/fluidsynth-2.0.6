...
#define MIDI_SYSEX_DEVICE_ID_DEFAULT    0x10    /**< Device ID used in SYSEX messages to indicate default device */
...
#define MIDI_SYSEX_GS_MODELID           0x42    /**< Sysex sub-ID #1 for Model ID (GS) */
